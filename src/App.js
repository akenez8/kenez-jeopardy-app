...
function App() {
  ...
  useEffect(() => {
    fetch("http://localhost:3001/FunFacts")
    .then(res => res.json())
    .then(data => setCat5(data))
    },[])
  ...
  return (
    <div className="App">
      <p className="title">KENEZ JEOPARDY</p>
      ...
      <div className="scoreButtonsDiv">
        <button className="addButton" onClick={addTeam1Points}>
          +100
        </button>{" "}
        <button className="subtractButton" onClick={subtractTeam1Points}>
          -100
        </button>
        <button className="addButton" onClick={addTeam2Points}>
          +100
        </button>{" "}
        <button className="subtractButton" onClick={subtractTeam2Points}>
          -100
        </button>
        <button className="addButton" onClick={addTeam3Points}>
          +100
        </button>{" "}
        <button className="subtractButton" onClick={subtractTeam3Points}>
          -100
        </button>
        <button className="addButton" onClick={addTeam4Points}>
          +100
        </button>{" "}
        <button className="subtractButton" onClick={subtractTeam4Points}>
          -100
        </button>
      </div>
      <div className="boardDiv">
        <Board cat1={cat1} cat2={cat2} cat3={cat3} cat4={cat4} cat5={cat5}/>
      </div>
    </div>
  );
}
